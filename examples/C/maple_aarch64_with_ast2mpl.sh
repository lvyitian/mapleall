...
CURRDIR=`pwd`
WORKDIR=$CURRDIR/aarch64_use_ast2mp
...
# .mpl -> .s
echo $MAPLE_ROOT/bin/aarch64-clang-release/maple -exe=me,mplcg -option=\"-O2 --quiet:-O2 -quiet\" $name.mpl
$MAPLE_ROOT/bin/aarch64-clang-release/maple -exe=me,mplcg -option="-O2 --quiet:-O2 -quiet" $name.mpl > doit.log
