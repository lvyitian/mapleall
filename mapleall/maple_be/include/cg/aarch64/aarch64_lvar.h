...
class AArch64OptLocalRef : public OptLocalRef {
  ...
  MapleSet<AArch64MemOperand *> other_opnd;  // other memory opnd requires patching
 ...
 public:
  explicit AArch64OptLocalRef(CGFunc *func, MemPool *mp)
    : OptLocalRef(func, mp),
      olr_allocator(mp),
      min_imm(0x0fffffff),
      max_imm(0),
