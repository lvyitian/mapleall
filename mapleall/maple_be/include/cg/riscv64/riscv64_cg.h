...
class Riscv64CG : public CG {
 ...
 public:
  explicit Riscv64CG(MIRModule *mod, const CGOptions &opts, bool runCg, const char *output,
...
#if DEBUG
  explicit Riscv64CG(MIRModule *mod, const CGOptions &opts, bool run_cg, const char *output,
