...
namespace maplebe {
void Riscv64CGFunc::SelectVecAdd(Operand *resopnd, Operand *opnd0, Operand *opnd1, PrimType prmtyp) {
  ...
  curbb->AppendInsn(cg->BuildInstruction<Riscv64Insn>(mop, resopnd, newOpnd0, newOpnd1));
}
} // namespace maplebe
