...
bool RaX0Opt::PropagateX0DetectRedefine(const Riscv64MD *md, Insn *ninsn, const X0OptInfo &optVal,
                                                       uint32 index) {
  bool isdef = static_cast<Riscv64OpndProp *>(md->operand_[index])->IsRegDef();
  if (isdef) {
